...
import subprocess
from qc_run.sub_job import gaussian as sub_gaussian
...
parser.add_option("-v", dest="version", help="Version de Gaussian a usar (default = 16-AVX.lua)", default="16-AVX.lua")
...
sbatch_string, jobName = sub_gaussian(run_dir, nprocs = proc_num, mem = mem, partition = queue, inp = inputFile, out = outputFile, version=version,  name = jname)
