...
import subprocess
from qc_run.sub_job import orca_amd as sub_orca
...
parser.add_option("-q", dest="queue", help="Cola de destino (default = amd)", default="amd")
...
parser.add_option("-v", dest="version", help="Version de Orca a usar (default = orca_4_2_1_linux_x86-64_openmpi314)", default="orca_4_2_1_linux_x86-64_openmpi314")
